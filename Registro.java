...
public class Registro {
    ...
    public static void main(String[] args) {
        ...
        tamañoAgenda = Integer.parseInt(JOptionPane.showInputDialog(null, "Cual es el tamaño de la agenda?"));//Permite convertir a entero un valor ingresado por el usuario en un cuadro de diálogo
