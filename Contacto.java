...
public class Contacto {
    ...
    @Override
    public String toString() {//El método toString te devuelve una representación en cadena de texto del objeto sobre el cual lo invoques. Es muy útil cuando quieres devolver un resumen del estado interno del objeto. 
